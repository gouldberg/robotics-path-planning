...
# HERE TORUS is considered
# when M=100, i = 0, j = 0
# min is taken from either of:
#   map[0,0],
#   1 + map[99,0]
#   99 + map[0,0]
#   1 + map[0,99]
...
# -----------------------------------------------------------------------------------------------------
# Obstacle Avoidance
#   - Here obstacle is only circle
#   - This does not consider inverse kinematics
# -----------------------------------------------------------------------------------------------------
...
# each obstacle, xy coordinate and radius
obstacles = [[1.75, 0.75, 0.6], [0.55, 1.5, 0.5], [0, -1, 0.7], [0, -0.6, 0.4], [-1, 1., 0.3]]


# Arm geometry in the working space
link_length = [0.5, 0.5, 0.3, 0.5, 0.1]
initial_link_angle = [0., 0., 0., 0., 0.]
